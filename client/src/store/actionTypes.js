...
export const GET_AFOLLOWERS_ERROR = 'GET_FOLLOWERS_ERROR';

export const GET_ONE_CHAT = 'GET_ONE_CHAT';
export const GET_ONE_CHAT_SUCCESS = 'GET_ONE_CHAT_SUCCESS';
export const GET_ONE_CHAT_ERROR = 'GET_ONE_CHAT_ERROR';
